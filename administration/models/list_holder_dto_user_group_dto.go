...
// ListHolderDtoUserGroupDto list holder dto user group dto
// swagger:model ListHolderDto«UserGroupDto»
...
func (m *ListHolderDtoUserGroupDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoUserGroupDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoUserGroupDto
