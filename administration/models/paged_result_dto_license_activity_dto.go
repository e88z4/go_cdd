...
// PagedResultDtoLicenseActivityDto paged result dto license activity dto
// swagger:model PagedResultDto«LicenseActivityDto»
...
func (m *PagedResultDtoLicenseActivityDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagedResultDtoLicenseActivityDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoLicenseActivityDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoLicenseActivityDto
