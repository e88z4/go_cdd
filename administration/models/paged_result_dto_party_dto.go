...
// PagedResultDtoPartyDto paged result dto party dto
// swagger:model PagedResultDto«PartyDto»
...
func (m *PagedResultDtoPartyDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoPartyDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoPartyDto
