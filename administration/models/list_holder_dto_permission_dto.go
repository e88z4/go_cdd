...
// ListHolderDtoPermissionDto list holder dto permission dto
// swagger:model ListHolderDto«PermissionDto»
...
func (m *ListHolderDtoPermissionDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoPermissionDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoPermissionDto
