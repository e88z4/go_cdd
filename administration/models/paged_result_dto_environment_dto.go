...
// PagedResultDtoEnvironmentDto paged result dto environment dto
// swagger:model PagedResultDto«EnvironmentDto»
...
func (m *PagedResultDtoEnvironmentDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoEnvironmentDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoEnvironmentDto
