...
// ListHolderDtoTenantDto list holder dto tenant dto
// swagger:model ListHolderDto«TenantDto»
...
func (m *ListHolderDtoTenantDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoTenantDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoTenantDto
