...
// PagedResultDtoProjectUserDto paged result dto project user dto
// swagger:model PagedResultDto«ProjectUserDto»
...
func (m *PagedResultDtoProjectUserDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoProjectUserDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoProjectUserDto
