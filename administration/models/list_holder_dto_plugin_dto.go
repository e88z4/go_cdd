...
// ListHolderDtoPluginDto list holder dto plugin dto
// swagger:model ListHolderDto«PluginDto»
...
func (m *ListHolderDtoPluginDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoPluginDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoPluginDto
