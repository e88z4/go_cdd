...
// PagedResultDtoApplicationDto paged result dto application dto
// swagger:model PagedResultDto«ApplicationDto»
...
func (m *PagedResultDtoApplicationDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoApplicationDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoApplicationDto
