...
// PagedResultDtoPairDto paged result dto pair dto
// swagger:model PagedResultDto«PairDto»
...
func (m *PagedResultDtoPairDto) validateData(formats strfmt.Registry) error {
