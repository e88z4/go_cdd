...
// ListHolderDtoSamlDomainDto list holder dto saml domain dto
// swagger:model ListHolderDto«SamlDomainDto»
...
func (m *ListHolderDtoSamlDomainDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoSamlDomainDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoSamlDomainDto
