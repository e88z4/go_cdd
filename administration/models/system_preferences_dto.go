...
// SystemPreferencesDto system preferences dto
// swagger:model SystemPreferencesDto
...
func (m *SystemPreferencesDto) validateData(formats strfmt.Registry) error {
