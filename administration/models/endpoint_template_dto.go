...
// EndpointTemplateDto endpoint template dto
// swagger:model EndpointTemplateDto
...
func (m *EndpointTemplateDto) validateTemplateParameters(formats strfmt.Registry) error {
