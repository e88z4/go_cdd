...
// ListHolderDtoFreezePeriodDto list holder dto freeze period dto
// swagger:model ListHolderDto«FreezePeriodDto»
...
func (m *ListHolderDtoFreezePeriodDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoFreezePeriodDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoFreezePeriodDto
