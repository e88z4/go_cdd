...
// ListHolderDtoEnvironmentDto list holder dto environment dto
// swagger:model ListHolderDto«EnvironmentDto»
...
func (m *ListHolderDtoEnvironmentDto) validateData(formats strfmt.Registry) error {
...
func (m *ListHolderDtoEnvironmentDto) UnmarshalBinary(b []byte) error {
	var res ListHolderDtoEnvironmentDto
