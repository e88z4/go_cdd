...
// PagedResultDtoUserDto paged result dto user dto
// swagger:model PagedResultDto«UserDto»
...
func (m *PagedResultDtoUserDto) validateData(formats strfmt.Registry) error {
