...
// ListHolderDtoRoleDto list holder dto role dto
// swagger:model ListHolderDto«RoleDto»
...
func (m *ListHolderDtoRoleDto) validateData(formats strfmt.Registry) error {
