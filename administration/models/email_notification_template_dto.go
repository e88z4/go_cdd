...
// EmailNotificationTemplateDto email notification template dto
// swagger:model EmailNotificationTemplateDto
...
func (m *EmailNotificationTemplateDto) validateConnectivityArguments(formats strfmt.Registry) error {
...
func (m *EmailNotificationTemplateDto) validateModifier(formats strfmt.Registry) error {
...
func (m *EmailNotificationTemplateDto) UnmarshalBinary(b []byte) error {
	var res EmailNotificationTemplateDto
