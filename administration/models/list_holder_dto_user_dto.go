...
// ListHolderDtoUserDto list holder dto user dto
// swagger:model ListHolderDto«UserDto»
...
func (m *ListHolderDtoUserDto) validateData(formats strfmt.Registry) error {
