...
// PagedResultDtoProjectDto paged result dto project dto
// swagger:model PagedResultDto«ProjectDto»
...
func (m *PagedResultDtoProjectDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoProjectDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoProjectDto
