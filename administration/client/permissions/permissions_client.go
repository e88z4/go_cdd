...
func (a *Client) GetPermissionsUsingGET(params *GetPermissionsUsingGETParams) (*GetPermissionsUsingGETOK, error) {
	...
	if params == nil {
		params = NewGetPermissionsUsingGETParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getPermissionsUsingGET",
		Method:             "GET",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetPermissionsUsingGETReader{formats: a.formats},
	...
	success, ok := result.(*GetPermissionsUsingGETOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getPermissionsUsingGET: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
