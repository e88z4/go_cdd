...
// NewUpdateUserUsingPUTParams creates a new UpdateUserUsingPUTParams object
// with the default values initialized.
func NewUpdateUserUsingPUTParams() *UpdateUserUsingPUTParams {
	var ()
	return &UpdateUserUsingPUTParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateUserUsingPUTParamsWithTimeout creates a new UpdateUserUsingPUTParams object
...
// NewUpdateUserUsingPUTParamsWithContext creates a new UpdateUserUsingPUTParams object
...
// NewUpdateUserUsingPUTParamsWithHTTPClient creates a new UpdateUserUsingPUTParams object
...
/*UpdateUserUsingPUTParams contains all the parameters to send to the API endpoint
for the update user using p u t operation typically these are written to a http.Request
*/
