...
// NewCreateUsersUsingPOSTParams creates a new CreateUsersUsingPOSTParams object
// with the default values initialized.
func NewCreateUsersUsingPOSTParams() *CreateUsersUsingPOSTParams {
	var ()
	return &CreateUsersUsingPOSTParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateUsersUsingPOSTParamsWithTimeout creates a new CreateUsersUsingPOSTParams object
...
// NewCreateUsersUsingPOSTParamsWithContext creates a new CreateUsersUsingPOSTParams object
...
// NewCreateUsersUsingPOSTParamsWithHTTPClient creates a new CreateUsersUsingPOSTParams object
...
/*CreateUsersUsingPOSTParams contains all the parameters to send to the API endpoint
for the create users using p o s t operation typically these are written to a http.Request
*/
...
func (o *CreateUsersUsingPOSTParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UserListDto != nil {
		if err := r.SetBodyParam(o.UserListDto); err != nil {
			return err
		}
	}
