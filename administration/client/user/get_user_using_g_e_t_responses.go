...
func (o *GetUserUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /users/{userId}][%d] getUserUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetUserUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /users/{userId}][%d] getUserUsingGETUnauthorized ", 401)
}
...
func (o *GetUserUsingGETForbidden) Error() string {
	return fmt.Sprintf("[GET /users/{userId}][%d] getUserUsingGETForbidden ", 403)
}
...
func (o *GetUserUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /users/{userId}][%d] getUserUsingGETNotFound ", 404)
}
