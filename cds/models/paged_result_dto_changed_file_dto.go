...
// PagedResultDtoChangedFileDto paged result dto changed file dto
// swagger:model PagedResultDto«ChangedFileDto»
...
func (m *PagedResultDtoChangedFileDto) validateData(formats strfmt.Registry) error {
...
func (m *PagedResultDtoChangedFileDto) UnmarshalBinary(b []byte) error {
	var res PagedResultDtoChangedFileDto
