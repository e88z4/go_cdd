...
type TestSuiteResultsApiService service

/* 
TestSuiteResultsApiService Retrieve test suite result
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId applicationId
 * @param applicationVersionId applicationVersionId
 * @param optional nil or *GetTestSuiteResultUsingGETOpts - Optional Parameters:
     * @param "TestSuiteExecutionId" (optional.String) -  testSuiteResultId
     * @param "SortField" (optional.String) -  sortField
     * @param "TestCaseResultStatus" (optional.Interface of []string) -  testCaseStatuses
     ...
     * @param "PluginId" (optional.Int64) -  pluginId
...
@return PagedResultDtoTestSuiteResultDto
*/

type GetTestSuiteResultUsingGETOpts struct { 
	TestSuiteExecutionId optional.String
	SortField optional.String
	TestCaseResultStatus optional.Interface
	Embed optional.Interface
	SortDirection optional.String
	Filter optional.String
	EndpointId optional.Int64
	PluginId optional.Int64
	Tag optional.String
...
func (a *TestSuiteResultsApiService) GetTestSuiteResultUsingGET(ctx context.Context, applicationId int64, applicationVersionId int64, localVarOptionals *GetTestSuiteResultUsingGETOpts) (PagedResultDtoTestSuiteResultDto, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PagedResultDtoTestSuiteResultDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{applicationId}/application-versions/{applicationVersionId}/test-suite-results"
	...
	if localVarOptionals != nil && localVarOptionals.TestSuiteExecutionId.IsSet() {
		localVarQueryParams.Add("test_suite_execution_id", parameterToString(localVarOptionals.TestSuiteExecutionId.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.TestCaseResultStatus.IsSet() {
		localVarQueryParams.Add("test_case_result_status", parameterToString(localVarOptionals.TestCaseResultStatus.Value(), "multi"))
	}
	...
	if localVarOptionals != nil && localVarOptionals.PluginId.IsSet() {
		localVarQueryParams.Add("plugin_id", parameterToString(localVarOptionals.PluginId.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PagedResultDtoTestSuiteResultDto
